        ...
        return this.each(function() {
            ...
            btn.click(function(e) {
                ...
                if (isActive) {
                	...
                	if(null != activeBtn){
                		/*activeBtn.parent("li").children(".treeview-menu").first().slideUp();
                		activeBtn.children(".fa-angle-down").first().removeClass("fa-angle-down").addClass("fa-angle-left");
                		activeBtn.parent("li").removeClass("active");
                		activeBtn =  null;*/
                		activeBtn.click();
                    }
